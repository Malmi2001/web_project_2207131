(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.PayHere = factory());
  ...
  */
  ...
  var PayHereClient = /** @class */ (function () {
      function PayHereClient() {
      ...
      PayHereClient.prototype.launch = function (_a) {
          var embedURL = _a.embedURL, customerName = _a.customerName, customerEmail = _a.customerEmail, disableCustomer = _a.disableCustomer, amountInCents = _a.amountInCents, hideAmount = _a.hideAmount, customFields = _a.customFields, onSuccess = _a.onSuccess, onFailure = _a.onFailure, onClose = _a.onClose;
          if (onSuccess)
      ...
      PayHereClient.prototype.setupButtonListeners = function () {
          document.addEventListener("click", function (e) {
              var match = e.target.closest("[data-payhere-embed]");
              if (!match || PayHere.modalOpen)
                  return;
              e.preventDefault();
              e.stopPropagation();
              var embedURL = match.getAttribute("data-payhere-embed");
              var customerName = match.getAttribute("data-payhere-customer-name");
              var customerEmail = match.getAttribute("data-payhere-customer-email");
              var disableCustomer = match.getAttribute("data-payhere-disable-customer");
              var amountInCents = match.getAttribute("data-payhere-amount");
              var hideAmount = match.getAttribute("data-payhere-hide-amount");
              if (!embedURL) {
      ...
      PayHereClient.prototype.setupIframeListeners = function () {
          window.addEventListener("message", function (e) {
              switch (e.data.message) {
                  case "payhere:ready":
                      var loadingSpinner = document.querySelector("." + styles.ldsRing);
                      var embedWrap = document.querySelector("." + styles.embedModal);
                  ...
                  case "payhere:failure":
                      ...
                      break;
                  case "payhere:close":
                      var embed = document.querySelector("." + styles.embedContainer);
                      embed && embed.remove();
      ...
      return PayHereClient;
  }());
  var PayHere = new PayHereClient();
